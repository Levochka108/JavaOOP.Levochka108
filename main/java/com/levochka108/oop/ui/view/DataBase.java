package main.java.com.levochka108.oop.ui.view;
...
public class DataBase {
    public void showData() {
        ...
        products.add(new Product("Зубная счетка", 120.50, 1,2));
        products.add(new Milk("Кот и Молоко", 60.50,60,1,1,3.2));
        products.add(new Bread("Хлебушек святой рыженький", 45.99,100,12,new Date(23, Calendar.APRIL ,24),"Мука цельно зерновая",false,false,false,false));
